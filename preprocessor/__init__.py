...
from preprocessor.downstream import get_processed_items, get_stats
...
__all__ = [
    # 旧接口
    'strip_html', 'normalize_title', 'deduplicate',
    ...
    'build_output', 'get_processed_items', 'get_stats', 'format_summary',
]
